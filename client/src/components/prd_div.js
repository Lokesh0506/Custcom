...
<div className="prd_div">
  ...
  <BUTTON onClick={addToCart} style={setStyle(props.data, 'add_to_cart')} id="add_to_cart" className="add_to_cart" type="submit" enableHover={props.enableHover} value="Add to Cart"/>
   </div>
</div>
